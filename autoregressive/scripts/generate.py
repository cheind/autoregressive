...
def load_model(cli: GenerateLightningCLI) -> wave.WaveNet:
...
def create_obs(cli: GenerateLightningCLI) -> torch.Tensor:
    dm = cli.datamodule
...
if __name__ == "__main__":
    # python -m autoregressive.scripts.generate2 --config models\fseries\config.yaml "models\fseries\wavenet-epoch=16-val_loss_epoch=4.9223.ckpt"
    main()
